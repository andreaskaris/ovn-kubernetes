...
// We define a physical interface as any interface of types "device" and "vlan" (exluding the loopback).
// When an interface is removed, syncPhysicalInterfaceDropRules will make sure to delete the iptables rules for it.
