...
// isImplicitDualStackIpFamilyPolicy checks if the service implicitly sets ipFamilyPolicy for DualStack
// services.
...
func isImplicitDualStackIpFamilyPolicy(service *v1.Service) bool {
	...
	for _, entry := range managedFieldEntries {
		...
		// This service definition contains an explicit ipFamilyPolicy, return false
