...
func (c *Controller) syncService(key string) error {
	...
	// OCP HACK
	// Check if the service implicitly sets ipFamilyPolicy for DualStack services (deprecated in 4.8 and 4.9
	// as admins must set ipFamilyPolicy explicitly in 4.10 and beyond
